...
import lesson4.builder.AddShoppingItemRequestBuilder;
import lesson4.builder.ConnectUserRequestBuilder;
...
public class SpoonacularChainApiTest extends AbstractTest {
    ...
    void createShoppingListChainTest() throws JsonProcessingException {
        ...
        given() //Создание Shopping list
                ...
                .post(getBaseUrl() + "/mealplanner/{username}/shopping-list/{start-date}/{end-date}",
                        userInfoResponse.getUsername(), "2023-07-15", "2023-07-21") //Endpoints запроса
                .then()
